...
function setClientID(){
  ...
  if(!getCookie(name) || getCookie(name) === 'undefined'){
   ...
   // console.log(clientID)
    var cookie_set = name+"="+ clientID + expires+"; path=/";
   // console.log(cookie_set)
    ...
    // gtag('config', 'UA-92340519-1', {
    //   'cookie_prefix': '_lnd__',
    //   'cookie_domain': '/',
    //   'cookie_expires': 365 * 24 * 60 * 60,  // 28 days, in seconds
    //   'user_id': clientID,
    ...
    var clientID = getCookie('_lnd_client_id')
